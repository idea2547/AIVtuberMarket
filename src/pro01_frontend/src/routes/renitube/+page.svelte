...
<div class="w-full min-h-screen flex flex-col items-center justify-center">
    <div class="card variant-soft-surface p-4">
        <div class="card-header p-4">
            <h1 class="text-2xl font-bold text-center">VTube Preview</h1>
        </div>
        <div id="videoLayer" class="border-t border-t-surface-500 border-b border-b-surface-500 bg-[url('/resource/hiyori_pro_en/grid.png')]">
            <ReniTubeShow />
            <div class="mb-4 w-1/2 mx-auto flex items-center justify-start variant-soft-surface rounded-2xl px-2">
                <button type="button" class="btn-icon !bg-transparent">▶</button>
            </div>
        </div>
        <div class="card-footer flex justify-center p-4">
            <button class="btn variant-ghost-tertiary">ดาวน์โหลดวีดีโอ</button>
        </div>
    </div>
    <div class="w-1/2 flex items-center justify-center gap-2">      
        <textarea bind:value={text} class="textarea" placeholder="Input any text"></textarea>
        <button class="btn variant-filled p-4" on:click={handleGenerateSound} disabled={isLoading}>GenerateSound</button>
