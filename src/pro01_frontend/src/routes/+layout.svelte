...
<script>
  ...
  let userAddress = '';
  let contractAddress = '0x061515f8Bf0205d8e6EBBE40Bf2b3054c97d899E'
  onMount(() => {
        if (window.ethereum) {
...
<svelte:head>
    <script defer src="/live2d.min.js"></script>
    <script defer src="/live2dcubismcore.min.js"></script>
</svelte:head>

<div class="min-h-screen flex flex-col">
  <header class="bg-base-100 shadow-lg">
    <div class="container mx-auto px-4 py-3 flex justify-between items-center">
      <a href="/" class="text-2xl font-bold text-primary">AI VTuber Marketplace</a>
      <nav>
        <ul class="flex space-x-4">
          <li><a href="/marketplace" class="btn btn-ghost">Marketplace</a></li>
          <li><a href="/create" class="btn btn-ghost">Create</a></li>
          <li><a href="/" class="btn btn-ghost">Profile</a></li>
          {#if isConnected}
          <li><p class="btn btn-ghost">Connected!</p></li>
